...
messagebox.showinfo(message="Se ha detectado un libro fuera de su anaquel", title="Alerta")
...
def localizacion(a,b,c):
   ...
   las antenas
    ...
    messagebox.showinfo(message="Se ha detectado el libro: (%s)" %random.choice(libros), title="Info")
    ...
    ran = ([path1, path2, path3, path4, path5, path6, path7, path8, path9, path10,path11, path12, path13])
